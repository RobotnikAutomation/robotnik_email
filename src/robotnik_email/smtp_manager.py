...
class SMTPManager(RComponent):
    ...
    def ros_read_params(self):
        ...
        self.sender =  rospy.get_param('~sender', 'sender@domain.com')
        self.use_authentication = rospy.get_param('~use_authentication', False)
        self.username = rospy.get_param('~username', 'username')
        self.password = rospy.get_param('~password', 'password')
        self.default_recipients = rospy.get_param('~default_recipients', 'recipient@domain.com')
        self.time_between_emails = rospy.get_param('~time_between_emails', 0)
